...
menu_section * LoadMenus(int & menuCount)
{
	...
	{
		{"\xED\xA3\x81", "Walls", 0, 1},
		{"\xED\xA3\x82", "Electronics", 0, 1},
		{"\xED\xA3\x96", "Powered Materials", 0, 1},
		{"\xED\xA3\x59", "Sensors", 0, 1},
		{"\xED\xA3\xA2", "Force", 0, 1},
		{"\xED\xA3\x83", "Explosives", 0, 1},
		{"\xED\xA3\x85", "Gasses", 0, 1},
		{"\xED\xA3\x84", "Liquids", 0, 1},
		{"\xED\xA3\x90", "Powders", 0, 1},
		{"\xED\xA3\x91", "Solids", 0, 1},
		{"\xED\xA3\x56", "Radioactive", 0, 1},
		{"\xED\xA3\x8C", "Special", 0, 1},
		{"\xED\xA3\x92", "Game Of Life", 0, 1},
		{"\xED\xA3\x97", "Tools", 0, 1},
		{"\xED\xA3\xA4", "Decoration tools", 0, 1},
		{"\xED\xA3\x88", "Cracker", 0, 0},
		{"\xED\xA3\x88", "Cracker!", 0, 0},
	};
	menuCount = SC_TOTAL;
